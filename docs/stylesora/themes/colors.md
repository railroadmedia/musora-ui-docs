    ...
    <div class="tw-py-8">
        ...
        <div class="tw-grid tw-grid-cols-3 md:tw-grid-cols-5 lg:tw-grid-cols-6 xl:tw-grid-cols-7 tw-gap-3">
            ...
            <div>
                ...
                <div class="tw-bg-gray-100 tw-p-2">
                    <p class="tw-text-xs tw-m-0 tw-font-bold">Singeo</p>
            ...
            <div>
                ...
                <div class="tw-bg-gray-100 tw-p-2">
                    <p class="tw-text-xs tw-m-0 tw-font-bold">Recordeo</p>
        ...
        <div class="tw-grid tw-grid-cols-3 md:tw-grid-cols-5 lg:tw-grid-cols-6 xl:tw-grid-cols-7 tw-gap-3">
            ...
            <div>
                <div class="tw-p-12 tw-bg-ui-gray-200"></div>
                <div class="tw-bg-gray-100 tw-p-2">
            ...
            <div>
                <div class="tw-p-12 tw-bg-ui-gray-300"></div>
                <div class="tw-bg-gray-100 tw-p-2">
            ...
            <div>
                <div class="tw-p-12 tw-bg-ui-gray-400"></div>
                <div class="tw-bg-gray-100 tw-p-2">
            ...
            <div>
                <div class="tw-p-12 tw-bg-ui-gray-500"></div>
                <div class="tw-bg-gray-100 tw-p-2">
            ...
            <div>
                <div class="tw-p-12 tw-bg-ui-gray-600"></div>
                <div class="tw-bg-gray-100 tw-p-2">
        ...
        <div class="tw-grid tw-grid-cols-3 md:tw-grid-cols-5 lg:tw-grid-cols-6 xl:tw-grid-cols-7 tw-gap-3">
            ...
            <div>
                <div class="tw-p-12 tw-bg-dm-gray-blue"></div>
                <div class="tw-bg-gray-100 tw-p-2">
            ...
            <div>
                <div class="tw-p-12 tw-bg-dm-royal-blue"></div>
                <div class="tw-bg-gray-100 tw-p-2">
            ...
            <div>
                <div class="tw-p-12 tw-bg-dm-dark-blue-1"></div>
                <div class="tw-bg-gray-100 tw-p-2">
            ...
            <div>
                <div class="tw-p-12 tw-bg-dm-dark-blue-2"></div>
                <div class="tw-bg-gray-100 tw-p-2">
            ...
            <div>
                <div class="tw-p-12 tw-bg-dm-dark-blue-3"></div>
                <div class="tw-bg-gray-100 tw-p-2">
        ...
        <div class="tw-grid tw-grid-cols-3 md:tw-grid-cols-5 lg:tw-grid-cols-6 xl:tw-grid-cols-7 tw-gap-3">
            ...
            <div>
                <div class="tw-p-12 tw-bg-ui-success"></div>
                <div class="tw-bg-gray-100 tw-p-2">
            ...
            <div>
                <div class="tw-p-12 tw-bg-ui-highlight"></div>
                <div class="tw-bg-gray-100 tw-p-2">
